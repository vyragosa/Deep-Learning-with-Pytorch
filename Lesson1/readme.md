...
Выполнил студент Фонин Дмитрий

Домашнее задание представлено в  данном [файле](Homework1.ipynb)
...
Домашнее задание 2: нарисуйте backward граф для выражения ab+cd. Теория и пример оформления. Сравните полученные теоретические значения с аттрибутами grad у исходных тензоров. Домашнее задание 3: Поэксперементируйте с размером тензоров, которые влезут на видеоркарту в Colab. Найдите максимальный размер тензора для типа данных float32, float64, float16, int32, int64. На сколько они отличаются.
